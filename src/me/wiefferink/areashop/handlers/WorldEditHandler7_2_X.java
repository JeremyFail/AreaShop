...
public class WorldEditHandler7_2_X extends WorldEditInterface {

	public WorldEditHandler7_2_X(AreaShopInterface pluginInterface) {
	...
	@Override
	// TODO: Deprecated WorldEdit methods will need to be fixed soon
